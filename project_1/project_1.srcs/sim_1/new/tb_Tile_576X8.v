...
reg [$clog2(576)-1:0] addr = 0;

// input buffer Outputs
wire [26*8-1:0] result;
wire result_ready;

wire [25:0] result_group [0:7];
reg [63:0] weight_mem [0:575]; 

reg [7:0] feature_mem [0:575];
reg [7:0] feature_mem_shifted [0:575];

initial begin
    $readmemh("C:/work_file/grade1/GROUP_RTL_CODE/python_verification/kernel_weights_576.txt", weight_mem);
end

initial begin
    $readmemh("C:/work_file/grade1/GROUP_RTL_CODE/python_verification/pixel_data_576.txt", feature_mem);
end
