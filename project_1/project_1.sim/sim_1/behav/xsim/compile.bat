...
REM
REM Generated by Vivado on Wed Nov 26 14:29:35 +0800 2025
...
echo "xvlog --incr --relax -prj tb_CIM_Group_vlog.prj"
call xvlog  --incr --relax -prj tb_CIM_Group_vlog.prj -log xvlog.log
