...
REM
REM Generated by Vivado on Wed Dec 03 17:14:34 +0800 2025
...
echo "xvlog --incr --relax -prj tb_512CIM_vlog.prj"
call xvlog  --incr --relax -prj tb_512CIM_vlog.prj -log xvlog.log
